                ...
                {googleIntegration.isConfigured ? (
                  <div className="integration-item">
                    ...
                    {isGoogleConnected ? (
                      ...
                      <div className="integration-not-configured" style={{padding: "8px 12px", textAlign: "left"}}>
                         <p style={{margin: 0, fontSize: "13px"}}>Sign in with Google to connect services like Gmail, Calendar, and Drive.</p>
                      </div>
                    )}
                  </div>
                ) : (
